      ...
      <div className="font-primary justify-center px-4 sm:px-6 md:px-8 py-8">
        <form onSubmit={handleSubmit} className="max-w-md mx-auto">
          <div className="border rounded-lg shadow-xl overflow-hidden">
            <div className="custom-bg custom-text border border-zinc-500 backdrop-filter backdrop-blur-xl p-4 sm:p-6 rounded-lg">
              <div className="space-y-4">
                ...
                <Button_1 isLoading={isLoading} onClick={handleSubmit} name="Submit Details" />
              </div>
            </div>
          </div>
        </form>
